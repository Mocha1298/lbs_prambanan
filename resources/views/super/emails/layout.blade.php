                                ...
                                <table class="col-600" width="600" height="400" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td align="center" style="line-height: 0px;">
                                            <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="https://3.bp.blogspot.com/-pzc4CW6TEeY/V_pMLNcHRKI/AAAAAAAADzA/TS7fda85nyo2PxXYGIMUPzkvdCjBn9wUgCLcB/s1600/Kabupaten%2BKlaten.png" width="109" height="103" alt="logo">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:24px; font-weight: bold; letter-spacing: 7px;">
                                            PETA <span style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 7px;">JALAN</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="font-family: 'Lato', sans-serif; font-size:15px; color:#ffffff; line-height:24px; font-weight: 300;">
                                            {{$details['baris1']}}<br>{{$details['baris2']}}
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            ...
                                            <table class="col3_one" width="380" border="0" align="right" cellpadding="0" cellspacing="0">
                                                ...
                                                <tbody><tr align="left" valign="top">
                                                    <td style="font-family: 'Raleway', sans-serif; font-size:20px; color:#f1c40f; line-height:30px; font-weight: bold;">{{$details['judul']}}</td>
                                                </tr>
                                                        ...
                                                        <table class="button" style="border: 2px solid #fff;" bgcolor="#2b3c4d" width="30%" border="0" cellpadding="0" cellspacing="0">
                                                            <tbody><tr>
                                                                ...
                                                                <td height="30" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#ffffff;">
                                                                    <a href="{{$details['notice']}}" style="color:#ffffff;">Lihat Laporan</a>
                                                                </td>
                                                                <td width="10"></td>
                                                            </tr>
                                                        </tbody></table>
