      ...
      <div class="popup">
        ...
        <div class="content">
          <form id="form" action="/objek_kerusakan_ubah/{{$kr->id}}" method="post" enctype="multipart/form-data">
            ...
            <fieldset>
              <input placeholder="Rencana Perbaikan" type="date" autocomplete="off" name="perbaikan" value="{{ old('perbaikan') ?? $kr->perbaikan }}" tabindex="5" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
